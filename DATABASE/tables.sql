...
CREATE TABLE tbl_account (AcctID INTEGER PRIMARY KEY,Type INTEGER,Name VARCHAR(100), Currency VARCHAR(3),StartingBalance NUMERIC,Notes TEXT);
...
CREATE TABLE tbl_transaction (TransactionID INTEGER PRIMARY KEY,SubID INTEGER,Type, Level1 VARCHAR(50), Level2 VARCHAR(50), AcctID INTEGER, 
...
CREATE TABLE tbl_transaction_tag (TransactionID INTEGER PRIMARY KEY,TagID INTEGER);
...
CREATE TABLE tbl_transaction_portfolio (TransactionID INTEGER PRIMARY KEY, SecurityCode VARCHAR(20), 
	Units INTEGER, PricePerUnit NUMERIC, Fees NUMERIC);
